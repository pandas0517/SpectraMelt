...
if __name__ == '__main__':
    ...
    lpf_cond_sig_freq_1 = np.fft.fftshift(np.abs(fft(lpf_cond_sig_1))) / (sim_freq_1*lpf_cond_total_time_1)
    ...
    lpf_cond_sig_freq_2 = np.fft.fftshift(np.abs(fft(lpf_cond_sig_2))) / (sim_freq_2*lpf_cond_total_time_2)
